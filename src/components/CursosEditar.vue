<template>
  ...
  export default {
    ...
    created() {
      ...
      axios.get('`https://apiwebsenac4.azurewebsites.net/cursos/${codigocurso}`).then(response => {
    ...
    methods: {
      submitForm() {        
        ...
        axios.put('`https://apiwebsenac4.azurewebsites.net/cursos/${codigocurso}`, this.curso).then(() => {
