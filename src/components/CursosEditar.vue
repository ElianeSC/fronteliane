<template>
  ...
  export default {
    ...
    created() {
      ...
      axios.get('`https://apiperguntaseliane.azurewebsites.net/cursos/${codigocurso}`).then(response => {
    ...
    methods: {
      submitForm() {        
        ...
        axios.put('`https://apiperguntaseliane.azurewebsites.net/cursos/${codigocurso}`, this.curso).then(() => {
