<template>
  ...
  export default {
    ...
    created() {
      ...
      axios.get(`https://apiwebsenac4.azurewebsites.net/alunosPorCurso/${codigocurso}`).then(response => {
        this.alunos = response.data;
      });
      axios.get(`https://apiwebsenac4.azurewebsites.net/cursos/${codigocurso}`).then(response2 => {
