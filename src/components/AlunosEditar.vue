<template>
  ...
  export default {
    ...
    created() {
      ...
      axios.get('https://apiwebsenac4.azurewebsites.net/alunos/'${codigoaluno}`).then(response => {
    ...
    methods: {
      submitForm() {        
        const codigoaluno = this.$route.params.codigoaluno;
        axios.put('https://apiwebsenac4.azurewebsites.net/alunos/${codigoaluno}`, this.aluno).then(() => {
